...
Toutes les valeurs sensibles se règlent via un fichier .env.
"""
import os
import sys
...
# 1. Détection dynamique et chargement unique du fichier .env
...
# 2. Sécurité et Mode d'exécution
...
# 3. Expiration de la session à la fermeture du navigateur (Déconnexion automatique)
...
MIDDLEWARE = [
    ...
    # Middlewares de sécurité : licence d'abord, création de compte admin ensuite
    "core.middleware.LicenceMiddleware",
    "core.middleware.PremierLancementMiddleware",
]
...
# 4. Configuration dynamique de la base de données PostgreSQL
DATABASES = {
    "default": {
